  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        '@type': 'WebApplication',
        name: 'Popular Pages',
        url: 'https://bookchaowalit-popular-pages.vercel.app',
        description: 'Popular Pages by Bookchaowalit - A modern web application',
  ...
  <script
    ...
    dangerouslySetInnerHTML={{
      __html: JSON.stringify({
        ...
        potentialAction: {
          '@type': 'SearchAction',
          target: 'https://bookchaowalit-popular-pages.vercel.app/more-projects',
